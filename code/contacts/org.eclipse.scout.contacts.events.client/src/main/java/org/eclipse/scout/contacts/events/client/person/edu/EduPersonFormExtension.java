...
/*
 * TODO Extensibility 1.1: uncomment extended class declaration, fix compile errors and add field 
 *                         user TEXTS.get("POBox"); for its label
 *                         
 * TODO Extensibility 1.2: annotate class so that an extension data is created
 * 
