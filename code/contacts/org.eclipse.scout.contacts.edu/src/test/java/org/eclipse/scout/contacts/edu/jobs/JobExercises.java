...
public class JobExercises {
  ...
  public void exercise_1() {
    Jobs.schedule(() -> log("exercise_1"), Jobs.newInput());
  }
  ...
  public void exercise_2() {
    IFuture<Void> future = Jobs.schedule(() -> log("exercise_2"), Jobs.newInput());
    future.awaitDone();
  }
  ...
  public void exercise_4() {
    ...
    Jobs.schedule(() -> log("exercise_4: job-1"),
        Jobs.newInput()
            .withExecutionHint("my-family"));

    // Schedule the second job
    Jobs.schedule(() -> log("exercise_4: job-2"), Jobs.newInput().withExecutionHint("my-family"));
  ...
  public void exercise_5() {
    Jobs.schedule(() -> log("exercise_5"), Jobs.newInput()
  ...
  public void exercise_9() {
    Jobs.schedule(() -> log("exercise_9"), Jobs.newInput()
        .withExecutionTrigger(Jobs.newExecutionTrigger()
  ...
  public void exercise_10() {
    Jobs.schedule(() -> log("exercise_10"), Jobs.newInput()
        .withExecutionTrigger(Jobs.newExecutionTrigger()
