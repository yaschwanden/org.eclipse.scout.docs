...
public class JobMigrationExercises {
  ...
  public void migrationExercise_1() {
    ...
    */
    ...
    Jobs.schedule(() -> printCurrentJobInfo(), Jobs.newInput()
        .withName("job-name"));
  }
  ...
  public void migrationExercise_3() {
    ...
    */
    ...
    ServerRunContexts.copyCurrent().run(() -> printCurrentJobInfo());
  }
  ...
  public void migrationExercise_4() {
    ...
    ModelJobs.schedule(() -> printCurrentJobInfo(), ModelJobs.newInput(ClientRunContexts.copyCurrent())
        .withName("job-name"));
  }
